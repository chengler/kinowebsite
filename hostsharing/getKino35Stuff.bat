...
wsl rsync -rv --delete -e "ssh -i  ~/.ssh/id_rsa" kkf00-kino35.de@kkf00.hostsharing.net:~/kinowebsite/static/lokal/ ../static/lokal/
echo ##################################
...
wsl rsync -rv --delete -e "ssh -i  ~/.ssh/id_rsa" kkf00-kino35.de@kkf00.hostsharing.net:~/kinowebsite/media/CACHE/images/filme/ ../media/CACHE/images/filme/
echo ##################################
